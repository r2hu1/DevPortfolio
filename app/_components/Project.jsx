...
export default function Project({ title, alt, image, description, url }) {
    return (
        <div className="border bg-background dark:bg-secondary max-w-fit rounded-md grid place-content-center transition">
            <div className="m-2 rounded-md relative border">
                ...
                <img src={image} alt={title} className="max-w-[350px] h-[300px] rounded-md" />
            </div>
